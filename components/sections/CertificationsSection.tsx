...
export default function CertificationsSection() {
  return (
    <section id="certifications" className="px-4 py-6 sm:px-6 sm:py-8 border-b border-terminal-border">
      ...
      <div className="space-y-4">
        {certifications.map((cert) => (
          <div key={cert.name}>
            ...
            <div className="border-l-2 border-terminal-border pl-4 flex flex-col gap-0.5 text-sm">
