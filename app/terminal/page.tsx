...
export default function TerminalPage() {
  return (
    <div className="min-h-screen bg-terminal-bg flex items-center justify-center sm:p-4">
      <div className="w-full sm:max-w-2xl min-h-screen sm:min-h-0 sm:h-120 flex flex-col sm:rounded-lg overflow-hidden sm:border border-terminal-border sm:shadow-2xl sm:shadow-black/60">
        {/* Title bar */}
